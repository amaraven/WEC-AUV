...
function [eStorageBatteryLvl, wecBatteryLvl, auvBatteryLvl, auvSchedule] = simulateSystemOps(simTime, wec, auvFleet, energyStorage, incorpStagger)
...
for i = 1:length(simTime)  
    ...
    if i < length(simTime)
        ...
        % if any(auvReadyToDeploy ~= 0) 
            ...
            [eStorageFutureBattery, eStorageNoBatteryFlag] = energyStorage.estBattery(auvFleet, simTime(i+1), dt, auvToDeploy, wec);
